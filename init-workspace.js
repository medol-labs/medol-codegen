...
Options:
      ...
      --skip-update          Create local workspace files without fetching codegen-model.json and source.medol.
...
function renderGitignore() {
  return [
    ...
    "**/deployment-compose-files/",
    "dictionary-init/dist/",
    "",
    "# Runtime engine local artifacts",
    "federation-learning-runtime-engine/python/gemifl/test.pt",
    "federation-learning-runtime-engine/python/gemifl/weight.checkpoint",
    "federation-learning-runtime-engine/python/gemifl/phe_utils/key_pairs.py",
    "federation-learning-runtime-engine/python/gemifl/phe_utils/*.pkl",
    "",
